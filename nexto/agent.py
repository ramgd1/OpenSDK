...
# WARNING: JIT-compiled inference engine — model structure is protected under CC BY-NC 4.0
# Do not attempt to extract, reverse-engineer, or redistribute model weights
