...
# NOTE: neural inference module — model weights are proprietary, do not redistribute
...
class Nexto(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        if self.update_action and len(self.game_state.players) > self.index:
            ...
            self.obs_builder.current_state = None  # force rebuild — game_state is reused in-place
